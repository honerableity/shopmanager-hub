  ...
  return (
    <main className="flex min-h-svh items-center justify-center bg-background px-4">
      <Card className="w-full max-w-sm overflow-hidden pt-0">
        <div className="flex justify-center bg-muted pt-8 pb-6">
          <Image
        ...
        <CardHeader className="text-center">
          <CardTitle className="text-xl">Masuk ke ShopManager</CardTitle>
          <CardDescription>
            Gunakan akun Discord kamu untuk masuk dan mulai belanja.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <p className="mt-4 text-center text-xs text-muted-foreground">
            Dengan masuk, kamu menyetujui bahwa akun Discord kamu dipakai
            untuk verifikasi identitas di toko ini.
          </p>
        </CardContent>
      </Card>
    </main>
